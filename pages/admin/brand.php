                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td class="border-bottom-0 d-flex align-items-center">
                        <a href="" class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target="#update-modal<?php echo $row['brand_id']; ?>">Update</a>
                        <a href="functions/delete_brand.php?id=<?php echo $row['brand_id']; ?>" class="btn btn-sm btn-danger">Delete</a>
                    </td>
                    <?php
                            }
                            }
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="save_brand"><i class="ti ti-device-floppy"></i> Save</button>
      </div>
      </form>
    </div>
  </div>
...
<div class="modal fade" id="update-modal<?php echo $row['brand_id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary" name="update_brand"><i class="ti ti-device-floppy"></i> Update</button>
      </div>
      </form>
    </div>
  </div>
